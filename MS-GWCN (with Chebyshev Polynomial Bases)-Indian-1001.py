...
data_dict = _safe_loadmat([os.path.join(base_dir, 'Indian_pines.mat'),
                           os.path.join(rel_dir,  'Indian_pines.mat')])

corrected_data = _safe_loadmat([os.path.join(base_dir, 'Indian_pines_corrected.mat'),
                                os.path.join(rel_dir,  'Indian_pines_corrected.mat')])

gt_data = _safe_loadmat([os.path.join(base_dir, 'Indian_pines_gt.mat'),
                         os.path.join(rel_dir,  'Indian_pines_gt.mat')])

# Extract hyperspectral data and ground truth
X = corrected_data['indian_pines_corrected']  # (145, 145, 200)
y = gt_data['indian_pines_gt']               # (145, 145)
